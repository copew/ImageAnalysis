...
%
tic
image_list = [619953,625916,626166,625923,625930,625936,625958,625946,625951,626018,626047,626102,626103,626160];
...
%% 
 % Now compute the tumour clusters with subsetting
    ...
    for this_core = 1:size(core_polygon,2)
        ...
        %calculating distances of nearest 15 neighbours
        ...
        [all_multi_real_distances_all{this_core}, all_indexes_all{this_core}] = pdist2([in_core{this_core}{X_ind}(neighbour_cells_all) in_core{this_core}{Y_ind}(neighbour_cells_all)],[in_core{this_core}{X_ind}(base_cells_all) in_core{this_core}{Y_ind}(base_cells_all)],'euclidean','Smallest', 16);
