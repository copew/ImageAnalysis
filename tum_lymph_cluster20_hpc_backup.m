...
image_list = [603283, 619799, 619857, 619872];
% next. not sure if output is in the right format though

% need to run: , 

% done
%593960,593971, 594006, 602915, 602942, 602976, 602994, 603253, 603269, 603271,  603298, 603956, 619905
...
%     
    ...
    save(['./' num2str(image_filenumber) '/t_l_intersection20.mat'], 't_l_intersection');
    csvwrite(['./' num2str(image_filenumber) '/' num2str(image_filenumber) '_lymph_intersection_count20.csv'], t_l_intersection_lymph_count_cell);
    csvwrite(['./' num2str(image_filenumber) '/' num2str(image_filenumber) '_intersection_area20.csv'], t_l_intersection_area_cell);
    csvwrite([ '/Users/cope01/Documents/OneDrive - University Of Cambridge/Documents/PhD/Neoadjuvant/tum_lymph_overlap/count/' num2str(image_filenumber) '_lymph_intersection_count20.csv'], t_l_intersection_lymph_count_cell);
    csvwrite(['/Users/cope01/Documents/OneDrive - University Of Cambridge/Documents/PhD/Neoadjuvant/tum_lymph_overlap/area/' num2str(image_filenumber) '_intersection_area20.csv'], t_l_intersection_area_cell);
    
    
    
    %this is added to work out the overlap or intersection, between lymphocyte and buffer
    %zones
    tbuffer_l_intersection = [];
    ...
    save(['./' num2str(image_filenumber) '/' num2str(image_filenumber) '_tbuffer_l_intersection20.mat'], 'tbuffer_l_intersection');
    csvwrite(['./' num2str(image_filenumber) '/' num2str(image_filenumber) '_lymphbuffer_intersection_count20.csv'], tbuffer_l_intersection_lymph_count_cell);
    csvwrite([ '/Users/cope01/Documents/OneDrive - University Of Cambridge/Documents/PhD/Neoadjuvant/tum_lymph_overlap/count/' num2str(image_filenumber) '_lymphbuffer_intersection_count20.csv'], tbuffer_l_intersection_lymph_count_cell);
    csvwrite(['./' num2str(image_filenumber) '/' num2str(image_filenumber) '_intersectionbuffer_area20.csv'], tbuffer_l_intersection_area_cell);
    csvwrite(['/Users/cope01/Documents/OneDrive - University Of Cambridge/Documents/PhD/Neoadjuvant/tum_lymph_overlap/area/' num2str(image_filenumber) '_intersectionbuffer_area20.csv'], tbuffer_l_intersection_area_cell);
