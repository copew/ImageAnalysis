...
%,603288, 603298,603292, 619872, 619857, 619905
...
load(['../workspace/' num2str(image_filenumber) '/' num2str(image_filenumber) '_workspace1.mat']);
...
% % % %     load(['./' num2str(image_filenumber) '/workspace1.mat']);
% % % % end
...
%% create non empty continuous polygon and buffers to allow for indexing later on
