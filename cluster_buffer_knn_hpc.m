...
%%
function cluster_buffer_knn_hpc(image_filenumber)
...
%turn into csv files
dlmwrite([num2str(image_filenumber) '_lymph_in_count.csv'], lymph_in_count_combined, 'precision', 10);
dlmwrite([num2str(image_filenumber) '_lymph_buffer_count.csv'], lymph_buffer_count_combined, 'precision', 10);
dlmwrite([num2str(image_filenumber) '_tumourcell_in_count.csv'], tumourcell_in_count_combined, 'precision', 10);
dlmwrite([num2str(image_filenumber) '_tumourcell_buffer_count.csv'], tumourcell_buffer_count_combined, 'precision', 10);
