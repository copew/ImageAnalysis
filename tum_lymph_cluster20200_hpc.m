...
mkdir(['./output20200/' num2str(image_filenumber)]);
...
%load data (only cells are kept, s2n ratio set at 1.3, overlap removed, and tumour and
%normal are combined)
...
% the useful output of this part is the core_polygon struct
...
save(['./output20200/' num2str(image_filenumber) '/' num2str(image_filenumber) '_workspace_clusters20200.mat']);
...
%% now save the files
save(['./output20200/' num2str(image_filenumber) '/' num2str(image_filenumber) '_tumour_polygon_in200.mat'], 'tumour_polygon_in');
save(['./output20200/'  num2str(image_filenumber) '/' num2str(image_filenumber) '_tumour_buffer_in200.mat'], 'tumour_buffer_in');
save(['./output20200/'  num2str(image_filenumber) '/' num2str(image_filenumber) '_lymphocyte_polygon20.mat'], 'lymphocyte_polygon');
...
save(['./output20200/' num2str(image_filenumber) '/' num2str(image_filenumber) '_t_l_intersection20200.mat'], 't_l_intersection');
...
for i=1:size(overlap_list, 2) %looking at the cores with tumours
    ...
    tbuffer_l_centroid_count{overlap_list(i)} = [];
...
csvwrite(['./output20200/' num2str(image_filenumber) '/' num2str(image_filenumber) '_lymphbuffer_intersection_count20200.csv'], tbuffer_l_intersection_lymph_count_cell);
csvwrite(['./output20200/' num2str(image_filenumber) '/' num2str(image_filenumber) '_intersectionbuffer_area20200.csv'], tbuffer_l_intersection_area_cell);
csvwrite(['./output20200/' num2str(image_filenumber) '/' num2str(image_filenumber) '_centroidbuffer_count20200.csv'], tbuffer_l_centroid_count_cell);
...
csvwrite(['./output20200/' num2str(image_filenumber) '/' num2str(image_filenumber) '_tumour_area_buffer200.csv'], tumour_buffer_area_combined);
...
csvwrite(['./output20200/' num2str(image_filenumber) '/' num2str(image_filenumber) '_lymph_buffer_count20200.csv'], lymph_buffer_count_combined);
% csvwrite(['./' num2str(image_filenumber) '/' num2str(image_filenumber) '_tumourcell_in_count.csv'], tumourcell_in_count_combined);
csvwrite(['./output20200/' num2str(image_filenumber) '/' num2str(image_filenumber) '_tumourcell_buffer_count200.csv'], tumourcell_buffer_count_combined);
