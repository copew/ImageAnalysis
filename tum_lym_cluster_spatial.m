...
%     csvwrite([output_dir '/outputfiles_tum_lymph/' num2str(image_filenumber) '/' num2str(image_filenumber) '_centroidin_count.csv'], t_l_centroid_count_cell);
%     csvwrite([ '/Users/cope01/Documents/OneDrive - University Of Cambridge/Documents/PhD/Neoadjuvant/tum_lymph_overlap/count/' num2str(image_filenumber) '_centroidin_count.csv'], t_l_centroid_count_cell);
%     
